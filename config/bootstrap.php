...
/*
 * Configure some functions specific to this aplication
 */
require __DIR__ . DS . "appFunctions.php";
/*
 * Bootstrap CakePHP.
 *
...
ServerRequest::addDetector('tablet',
        function ($request) {
    $detector = new \Detection\MobileDetect();
...
//setlocale(LC_ALL, 'fr_FR', 'fr_FR.utf-8', 'fr_FR.utf-8', 'french');
...
//\Cake\I18n\I18n::setLocale('fr-FR');
