    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#toto"><?= Configure::read('App.title') ?></a>
            </div>
            <div class="navbar-collapse collapse">
                ...
                echo $this->Form->control('ELEC_CLE',
                        [
                    'label' => '',
                    'title' => __('CLef élection À virer pour généralisation des écrans'),
                    "value" => $this->request->getData()['ELEC_CLE'] ?? "",
                    "placeholder" => "Clef Élection… À virer pour généralisation des écrans !"
                ]);
